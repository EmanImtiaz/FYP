...
<script>
   ...
   $('#payment_method_options').change(function () {
        ...
        if (selectedPaymentMethod === '1') {
            ...
            $('.form-check-input[name="payment_method"]:checked').trigger('click'); // Trigger click event on checked radio button
        } else {
    ...
    function handleSubmit() {
        const paymentMethod = $("select[name='payment_method_options']").val();
