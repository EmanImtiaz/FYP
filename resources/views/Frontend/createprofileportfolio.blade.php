        ...
        <div class="row row-cols-6 py-4">
            <div class="col">
                <div class="form-group">
                    <label for="profile_category_id" class="form-label">Select Category</label>
                    <select id="profile_category_id" required class="form-control" name="profile_category_id">
                        @foreach($profilecategories as $profilecategory)
                            <option value="{{ $profilecategory->id }}" {{ $profileportfolio->profile_category_id == $profilecategory->id ? 'selected' : '' }}>
